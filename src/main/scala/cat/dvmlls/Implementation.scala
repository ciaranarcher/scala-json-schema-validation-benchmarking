...
trait Implementation {
  def update(n:Int, d:Double):Int
  def delete(n:Int):Int
...
class JU_HM extends Implementation {
  ...
  override def delete(n: Int): Int = { map.remove(n) ; n }
...
class SC_I_HM extends Implementation {
  ...
  override def update(n: Int, d:Double): Int = { map += n -> d ; n }
  override def delete(n: Int): Int = { map -= n ; n }
  override def get(n:Int):Double = map.get(n).get
}
...
class SC_I_LM extends Implementation {
  ...
  override def update(n: Int, d:Double): Int = { map += n.toLong -> d ; n }
  override def delete(n: Int): Int = { map -= n ; n }
  override def get(n:Int):Double = map.get(n).get
}